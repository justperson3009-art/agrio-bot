...
class HybridAgroConsultant:
    ...
    def _init_simple_patterns(self) -> dict:
        ...
        return {
            ...
            # === КОРНЕПЛОДЫ: МОРКОВЬ ===
            'carrot_growing': {
                'patterns': ['морковь выращивание', 'морковь посев', 'как вырастить морковь', 'посев моркови', 'морковь посадка'],
                'answer': (
                    "🥕 **МОРКОВЬ: ВЫРАЩИВАНИЕ**\n\n"
                    "📅 **Сроки посева:**\n"
                    "• Ранняя: 20 апр - 5 май\n"
            ...
            # === КОРНЕПЛОДЫ: СВЕКЛА ===
            'beet_growing': {
                'patterns': ['свекла выращивание', 'свекла посев', 'как вырастить свеклу', 'посев свеклы', 'свёкла посадка'],
                'answer': (
                    "🔴 **СВЕКЛА: ВЫРАЩИВАНИЕ**\n\n"
                    "📅 **Сроки посева:**\n"
                    "• Ранняя: 1-10 май\n"
            ...
            # === ЛУКОВИЧНЫЕ: ЛУК ===
            'onion_growing': {
                'patterns': ['лук выращивание', 'лук посев', 'как вырастить лук', 'посев лука', 'лук из семян', 'лук чернушка'],
                'answer': (
            ...
            # === ЛУКОВИЧНЫЕ: ЧЕСНОК ===
            'garlic_growing': {
                'patterns': ['чеснок выращивание', 'чеснок посадка', 'как вырастить чеснок', 'озимый чеснок', 'яровой чеснок'],
                'answer': (
                    "🧄 **ЧЕСНОК: ВЫРАЩИВАНИЕ**\n\n"
                    "📅 **Сроки посадки:**\n"
